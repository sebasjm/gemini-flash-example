...
const App = () => {
  ...
  const updateCatalogs = (catalogs: Catalog[]) =>
    setState((prev) => ({ ...prev, catalogs }));
  const updateCategories = (categories: Category[]) =>
    setState((prev) => ({ ...prev, categories }));
  const updateLocations = (storageLocations: StorageLocation[]) =>
    setState((prev) => ({ ...prev, storageLocations }));
      ...
      case "catalog-detail":
        ...
        return (
          <CatalogDetail
            ...
            onUpdate={(updated) =>
              updateCatalogs(
                state.catalogs.map((c) => (c.id === updated.id ? updated : c)),
              )
            }
        ...
        return (
          <PublicCatalogView
            ...
            products={state.products.filter((p) =>
              publicCat.productIds.includes(p.id),
            )}
            categories={state.categories}
            storageLocations={state.storageLocations}
        ...
        return (
          <LocationDetail
            ...
            products={state.products.filter(
              (p) => p.storageLocationId === activeLoc.id,
            )}
      ...
      >
        ...
        <nav className="mt-6 px-4 space-y-1">
          ...
          <SidebarLink
            ...
            label={t("Catalogs")}
            active={
              state.currentView === "catalogs" ||
              state.currentView === "catalog-detail"
            }
            onClick={() => {
              setView("catalogs");
              setIsSidebarOpen(false);
          ...
          <SidebarLink
            ...
            active={
              ...
              state.currentView === "location-detail"
            }
            onClick={() => {
              setView("locations");
              setIsSidebarOpen(false);
